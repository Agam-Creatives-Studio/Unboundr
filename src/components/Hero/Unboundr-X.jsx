...
const ProgramContent = () => {
  ...
  const { skillDomains } = programxData;

  return (
    <div
      className="program-cont px-md-0 px-3"
      style={{ backgroundColor: '#2B2A60' }}
    >
      ...
      <div className="container-pro">
        <motion.div className="column" {...fadeUp}>
          ...
          <h3 className="sub-title">
            Final-year and pre-final-year college students
          </h3>
        </motion.div>

        <motion.div className="column" {...fadeUp}>
          <img src={Unb} alt="Streams" />
          <h3 className="sub-title">
            Streams: Engineering, IT, Management, Arts & Science
          </h3>
        </motion.div>
        ...
        <motion.div className="column" {...fadeUp}>
          ...
          <h3 className="sub-title">
            Institutions aiming to boost placement-readiness, confidence,
      ...
      <motion.div
        ...
        style={{ boxShadow: '1px', borderRadius: '20px' }}
        {...fadeUp}
      >
        {[
          ['Business English', 'Email Etiquette', 'Team Collaboration'],
          ['Leadership Communication', 'Resume Building', 'Interview Mastery'],
          ['Time Management', 'Focus', 'Stress Handling'],
          ['Integrity', 'Initiative', 'Growth Mindset'],
        ].map((group, i) => (
      ...
      <div className="card-grid">
        {[teach, time, role, cert].map((img, i) => {
          const texts = [
            <>
              <b>Delivery Format:</b>
              <br /> On-campus workshops, hybrid bootcamps, outbound retreats,
              online programs
            </>,
            <>
              <b>Duration:</b>
              <br /> Customizable based on your company’s or institution’s
              requirements.
            </>,
            <>
              <b>Method:</b>
              <br /> Hands-on simulations, gamified modules and outdoor
              activities
            </>,
            <>
              <b>Based on:</b>
              <br /> Iceberg Competency Model - traits, mindset & behavior
              focused
            </>,
          ];
          ...
          return (
            <motion.div className="card" key={i} {...fadeUp}>
              <img src={img} width="400px" alt="Unboundr" />
      ...
      <div className="wrapper py-4">
        <motion.h1 className="main-title2 pb-4 text-center" {...fadeUp}>
        ...
        <div className="container-c">
          ...
          <motion.div className="info-section" >
            ...
            <div className="social-links">
              ...
              <a
                href="https://api.whatsapp.com/send?phone=9363700179&text=Hi Team,%0AI'm interested to know more about Unboundr Programs. Thank you!"
                target="_blank"
                rel="noreferrer"
                className="me-3"
              >
