...
function ControlledCarousel() {
  ...
  const { ProductData, testimonials } = homeData;
  ...
  return (
    <>
      ...
      <div className="container pb-md-5 pb-3 mb-md-5 mt-md-0 mt-5">
        ...
        <div className="row align-items-center px-md-0 px-2">
          ...
          >
            <img
              src={About}
              alt="corporate training workshop Chennai"
          ...
          >
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              coaching through immersive, game-based programs grounded in
              psychology-backed coaching and real-world simulations. Our
              approach builds essential communication, leadership, and critical
              thinking skills, helping people thrive not just survive in a
        ...
        >
          <div className="col-md-9">
            ...
            <p className="text-white text-center para-section1">
              Unboundr delivers impactful programs in corporate training,
              startup coaching, and student readiness through experiential,
              gamified learning.
            </p>
          </div>
        </motion.div>
                ...
                <div className="d-flex flex-column align-items-center justify-content-between">
                  <div>
                    <img
                      width={70}
                      className="mb-3"
                      alt="experiential team-building program"
                      src={product.image}
                    />
            ...
            <div className="col-md-6 d-flex flex-column">
              ...
              >
                <img
                  src={teach}
                  width="80px"
                  alt="gamified coaching for leadership development"
                />
                <motion.p
                ...
                >
                  ...
                  Interactive, face-to-face sessions built for real-time
                  collaboration, peer learning, and hands-on simulations—right
              ...
              >
                ...
                >
                  ...
                  Conducted at retreat spaces or adventure venues, these
                  experiences blend physical challenges with leadership lessons,
                  emotional insight, and team bonding.
                </motion.p>
              </motion.div>
            </div>
            ...
            <div className="col-md-6 d-flex flex-column">
              ...
              >
                ...
                <motion.p
                  ...
                  viewport={{ once: false }}
                >
                  Distance is no barrier to transformation. Our online programs
                  are high-engagement and designed for modern learners—with
                  breakout rooms, live facilitation, scenario-based challenges,
                  and downloadable action sheets.
                </motion.p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  We design flexible learning paths combining onsite intensives,
                  online reinforcement, and outbound breakthroughs, tailored to
                  your people, timelines, and goals.
                </motion.p>
              </motion.div>
            </div>
          </div>
      ...
      <div className="container pb-5">
        <h2 className="main-title2 text-center py-md-5 py-4" data-aos="fade-up">
          For Institutions
        </h2>
        <div className="row align-items-center px-2" data-aos="fade-up">
          {/* <!-- Left Column: Dummy Image --> */}
          <motion.div
            className="col-md-6 pb-md-0 pb-4"
            initial={{ opacity: 0, x: -100 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: false }}
          >
            <img
              src={clg}
              alt="campus to corporate student training"
              className="contant-img img-fluid rounded shadow"
            />
          </motion.div>
          ...
          >
            <h2 className="section-title-black">
              Build Career-Ready Graduates
            </h2>
            <p>
              If your students excel academically but struggle in interviews or
              real-world settings, it is not a subject knowledge issue—it is a
              people skills gap.
            </p>
            <h2 className="section-title-black pt-md-0 pt-4">
            ...
            <div className="py-4">
              <Link to="/contact-us" className="carousel-btn primary">
                Enquire Now
              </Link>
            </div>
          </motion.div>
            ...
            >
              <div className="py-3">
                <h2 className="section-title-white">
                  Unlock Your Team’s Real Potential
                </h2>
                <p className="para-section1">
                  Even your best hire struggles without clarity, confidence, or
                  collaboration. We help you build a workforce that thinks,
                  adapts, leads, and grows.
                </p>
              </div>
        ...
        <div className="testimonial-slider">
          <Slider {...settings}>
            {testimonials.map((t, index) => (
              <div
                key={index}
                className="testimonial-card d-flex row justiyf-content-center align-items-center"
              >
        ...
        <section className=" col-md-9 mx-auto ">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: false }}
            >
              <h3 className="section-title-black text-center text-white">
                Sivakumar Damodaran
              </h3>
              <p className="para-section1 pb-md-4 pb-3">
                Sivakumar Damodaran is a Corporate Trainer, Facilitator, C.E.O
                and Founder of Unboundr, holds a Master’s degree in Computer
                Applications and is a seasoned entrepreneur with almost two
                decades of experience leading his own ventures. He is a
                Certified NLP Life Coach, a Certified Professional Trainer in
                the Design and Facilitation of Experiential Learning, and a
        ...
        <div className=" wrapper py-5 px-3">
          ...
          <div className="container-c">
            ...
            <div className="info-section px-2">
              ...
              <p>
                Whether you're a college looking to empower students, a company
                building stronger teams, or an individual seeking to grow—let's
