...
const ProgramContent = () => {
  ...
  return (
    <div className='program-cont px-md-0 px-3' style={{ backgroundColor: '#2B2A60' }}>
      ...
      {/* <!-- 4x3 Grid Paragraphs --> */}
      <div class="grid-container" style={{ boxShadow: '1px', borderRadius: '1px 1px 0px rgb(0 0 0 / 0%);' }} data-aos="fade-up">
        <div class="grid-item"><img src={rock} alt="Unboundr Logo" style={{ width: "20px", height: "20px", marginRight: "10px" }} /> Leading Without Authority
          <br /><br /><img src={rock} alt="Unboundr Logo" style={{ width: "20px", height: "20px", marginRight: "10px" }} />Constructive Feedback<br />
          <br /> <img src={rock} alt="Unboundr Logo" style={{ width: "20px", height: "20px", marginRight: "10px" }} />Strategic Thinking<br />
        </div>

        <div class="grid-item" data-aos="fade-up">    <img src={rock} alt="Unboundr Logo" style={{ width: "20px", height: "20px", marginRight: "10px" }} />Decision Making<br />
        ...
        <div class="grid-item" data-aos="fade-up"><img src={rock} alt="Unboundr Logo" style={{ width: "20px", height: "20px", marginRight: "10px" }} />Emotional Intelligence<br />
          ...
          <div class="container-c ">
            ...
            <div class="info-section">
              ...
              <div className="social-links">
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=9363700179&text=Hi Team, I'm interested to know more about Unboundr Programs. Thank you!"
                  target="_blank"
