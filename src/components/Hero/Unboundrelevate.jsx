    ...
    <div className='program-cont px-md-0 px-3' style={{ backgroundColor: '#2B2A60' }}>
      ...
      <div class="container-pro">
        ...
        <div class="column" data-aos="fade-up">
          ...
          <h3 className='sub-title'>Interns, management trainees, and entry-level hires (0–3 years experience)</h3>
        </div>

        {/* <!-- Column 2 --> */}
        <div class="column" data-aos="fade-up">
          <img src={Unb} alt="Students" />
          <h3 className='sub-title'>Startups, MSME Businesses, and growing teams looking to boost early employee performance</h3>
        </div>
  ...
  3 col */}
      ...
      <!-- Card 2 --> */}
        <div class="card" data-aos="fade-up">
          ...
          <div class="card-text"><b>Duration:</b><br />On-campus workshops, hybrid bootcamps, outbound retreats</div>
        </div>
